...
const (
	Log_Produce_FullMethodName       = "/mq.v1.Log/Produce"
	Log_Consume_FullMethodName       = "/mq.v1.Log/Consume"
	Log_ConsumeStream_FullMethodName = "/mq.v1.Log/ConsumeStream"
)
